    ...
    send: function (e, isGuess) {
      ...
      if (isGuess === true) {
        ...
        if (newChat === '') {
          ...
          return false
        } else if (newChat.search(/(办证|包小姐|http|退党|台独|藏独|疆独|傻逼|艹|妈了个逼|鸡巴|滚蛋|操你妈|性感|女优|强奸|乱伦|高潮|婊子|裸聊|法论功|反动|风骚|放荡|干你|春药|睾丸|暴乱|狗逼|腐败|贪污|受贿|激情|色情|妓女|嫖娼|贱逼|流氓|淫秽|淫荡|贱货|牛逼|性爱|龟头|禁忌|专业代理|帮忙点下|请点击进入|详情请进入|私家侦探|调查婚外情|借腹生子|免费试用|足球投注|质押贷款|证监会|信用卡提现|无抵押贷款|广告代理|原音铃声|代开发票|销售热线|订购热线|低价出售|客服电话|连锁加盟|加盟连锁|回复可见|刻章办|套牌车|高清在线|股市圈钱|资金短缺|替考试|考试答案|六合彩|代孕妈妈|小额贷款|出售|聊天室|六四风波|北京风波|新闻封锁|钓鱼岛|陈水扁|台湾国|台军|一中一台|劣等民族|高丽棒子|满狗|圣战组织|中共独裁|真善忍|中国猪|中华帝国|共匪|共产专制|跟踪定位|监听)/) !== -1) {
          self.$message.error('您的语句包含敏感词，请注意言行')
          return false
        }
      }
      this.chat.push({
